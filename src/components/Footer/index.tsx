  ...
  return(
    <Styled.Footer>
        <div className='social-medias social'>
          <h4>Contato</h4>
          <h2>Nos acompanhe!</h2>
          <p>Vivamus porttitor erat eu rhoncus aliquet. Nullam fermentum venenatis erat, eu facilisis velit.</p>
          <div className='social-links'>
            <Link href='https://www.instagram.com/dragisellialves/' target='_blank'>
        ...
        <div className='contacts'>
          <div className='phone'>
            <h4>LIGUE</h4>
            <span>(11) 9919-9999</span>
            <span>(11) 9999-8999</span>
          </div>
          <div className='location'>
            <h4>ENDEREÇO</h4>
            <span>Av. Lorem Ipsum, 51 - Jardim Lorim, São Paulo - SP, 37706-311</span>
          </div>
          </div>
    </Styled.Footer>
  )
